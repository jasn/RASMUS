...
\META{Exp}\>\IS\>\META{AtomConst}\OR \\
          ...
          %% \>   \>\META{IsType} \\
\\
\META{AtomConst}\>\IS\>\META{BoolConst}\OR\META{IntConst}\OR\META{TextConst} \\
\\
...
\\
\META{Type}\>\IS\>Bool\OR Int\OR Text\OR Tup\OR \\
           \>   \>Rel\OR Func\OR Any \\
%% \META{Type}\>\IS\>Bool\OR Int\OR Text\OR Atom\OR Tup\OR \\
%%            \>   \>Rel\OR Func\OR Any \\
\\
\META{StandardConst}\>\IS\>?-Bool\OR ?-Int\OR ?-Text \\
\\
...
The expressions {\tt is-Int(exp,A)} and {\tt is-Text(exp,A)} have
similar semantics.
