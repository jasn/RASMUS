	...
	\newcommand{\SS}[1]{\hspace*{#1\ttlength}}
	\newcommand{\qind}[1]{#1\index{#1}}
	\sprite{\grey}(12,7)[0.5\ttlength, 1.5ex]  
	:B......|
	:....B..|
	:.B.....|
	:.....B.|
...
\verb"Tup": & tupler
\end{tabular}
\end{center}\index{Int}\index{Text}\index{Bool}\index{Rel}\index{Tup}\index{Func}
...
typer
\end{description}
V\ae{}rdim\ae{}ngden i \verb"Int", \verb"Bool", \verb"Text", \verb"Tup" og
